      ...
      <div class="flex flex-col col-span-2 gap-4">
        <div class="flex flex-col  gap-2">
          ...
          <Field
            ...
            name="category" v-model="createRequestForm.amountCurrency" type="textarea" as="textarea">
        ...
        <div class=" flex gap-4  w-full col-span-2">
          <MainButton class="bg-green-600 border-none" text="التحويل الى CFO"></MainButton>
          <MainButton class="bg-orange-600 border-none" text="ارجاع لغرض التعديل"></MainButton>
          <MainButton class="bg-red-600 border-none" text="رفض"></MainButton>
        </div>
      </div>
              ...
              <tr class="bg-white border-b odd:bg-gray-100 even:bg-background text-sm" v-for="(item, index) in list"
                ...
                <td class="xl:py-3 xl:px-6 py-2 px-4">
                  ...
                  <div class="flex items-center gap-2">
                    <PhEye class="w-6 h-6 fill-primary hover:scale-105 transition-all duration-300 cursor-pointer"
                      @click="showRequestInfo(index), (isInfoModalOpen = true)" />
                  </div>
