      ...
      <div
        ...
        <div class="px-6 pt-4 pb-2">
          <span
            ...
            >{{ item.insertDate.split('T')[0] }}</span
          >
          <span
          ...
          <a :href="item.attachmentFile">
            <span
              class="inline-block bg-cyan-900 rounded-full px-3 py-1 text-sm font-semibold text-white mr-2 mb-2">
              Download
            </span>
          </a>
        </div>
